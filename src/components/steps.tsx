...
const stepData = [
  ...
  { num: 2, title: 'Step 2', description: 'Select Order' },
  { num: 3, title: 'Step 3', description: 'Pallet One' },
  { num: 4, title: 'Step 4', description: 'Pallet Two' },
  { num: 5, title: 'Step 5', description: 'Confirm and Submit' },
]
export function Steps() {
  return (
    <header className="flex h-[200px] items-start justify-center bg-sidebarMobile bg-cover bg-no-repeat p-6 lg:row-span-3 lg:row-start-2 lg:h-[540px] lg:justify-start lg:rounded-md lg:bg-sidebarDesktop lg:bg-cover lg:bg-center lg:pt-10">
      <ul className="flex gap-4 text-black lg:flex-col lg:gap-8">
